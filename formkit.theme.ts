...
/**
  ...
  *
  * @checksum - e7c03b75e268813e77f740ca6ff5b5821f3170b735d98866511ead234fd459d5
  * @variables - radius=rounded-lg,accentColor=blue,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow-none,baseColorShade=500,borderShadeLightMode=300,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "color__inner": {
    ...
    "group-data-[prefix-icon]:border-neutral-300": true,
    "group-data-[suffix-icon]:border": true,
    "group-data-[suffix-icon]:border-neutral-300": true,
  ...
  "range__input": {
    ...
    "group/input": true,
    "cursor-pointer": true,
    "[&::-webkit-slider-runnable-track]:bg-neutral-300/50": true,
    ...
    "[&::-webkit-slider-thumb]:group-data-[disabled]:!ring-neutral-200": true,
    ...
    "[&::-moz-range-track]:bg-neutral-300/50": true,
  ...
  "submit__input": {
    ...
    "disabled:border-neutral-300": true,
  ...
  "colorpicker__control": {
    ...
    "focus-visible:ring-blue-400": true
  },
  ...
  "colorpicker__fieldGroup": {
    ...
    "[&>input:focus]:ring-blue-500": true,
    "[&>input:focus]:border-blue-500": true,
  ...
  "colorpicker__swatch": {
    ...
    "[&>canvas:focus-visible]:ring-blue-400": true,
  ...
  "datepicker__dayCell": {
    ...
    "dark:focus:outline-blue-500": true,
  ...
  "datepicker__timeInput": {
    ...
    "p-1.5": true,
    "my-2.5": true,
    "focus-visible:outline-blue-500": true,
    "dark:text-neutral-300": true,
    "dark:bg-transparent": true,
    "dark:border-neutral-600": true
  },
  ...
  "datepicker__dayButton": {
    ...
    "dark:text-neutral-300": true,
    "dark:border-neutral-600": true,
    "dark:hover:border-blue-400": true
  },
  ...
  "slider__minValue": {
    ...
    "[&>div>div::after]:bg-neutral-300": true,
  ...
  "transferlist__outer": {
    ...
    "text-base": true,
    "max-w-none": true,
    "[&_.dnd-placeholder]:bg-blue-500": true,
  ...
  "transferlist__transferlist": {
    ...
    "[&:has(:focus-visible)]:ring-blue-400": true,
    "dark:border-neutral-600": true,
  ...
  "transferlist__transferlistListItem": {
    ...
    "dark:bg-neutral-800": true,
    "dark:text-neutral-300": true,
    "dark:data-[is-active=true]:bg-blue-800": true,
    "dark:aria-selected:bg-blue-800": true,
  ...
  "multi-step__tab": {
    ...
    "group-data-[tab-style=\"progress\"]/wrapper:data-[valid=\"true\"]:data-[visited=\"true\"]:after:bg-blue-500": true,
    ...
    "dark:group-data-[tab-style=\"progress\"]/wrapper:data-[valid=\"true\"]:data-[visited=\"true\"]:after:bg-blue-500": true
  },
  ...
  "multi-step__badge": {
    ...
    "text-white": true,
    "rounded-full": true,
    "group-data-[valid=\"true\"]/tab:bg-blue-500": true,
